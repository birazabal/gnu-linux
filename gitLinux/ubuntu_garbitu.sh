...
echo "**********************************************************"
echo "1.- Ubuntu 16.04 optimizatu"
echo "2.- Ubuntu 16.04 optimizatu - *makina zaharra"
echo "3.- Disko gogorraren atala guztiz ezabatu Wipe"
echo "4.- RAM memoria garbitu"
echo "5.- Antibirus, antispyware eta antirootkit-ak instalatu"
echo "6.- Iptables politikak ezarri"
echo "7.- Irten"
echo "0.- Oharrak"
